...
LINES = [
    ...
    ('nc_depreciation_ctr', 'ind_noncash', 'Depreciación acumulada sin gasto asociado (revisar)', 'indirect'),
    ('nc_asset_result', 'ind_noncash', 'Utilidad o pérdida en venta de activo fijo', 'indirect'),
    ...
    ('nc_fx_cash', 'ind_noncash', 'Diferencias cambiarias sobre efectivo (se presentan aparte)', 'indirect'),
    ('nc_interest', 'ind_noncash', 'Intereses a cargo (se presentan en financiamiento)', 'indirect'),
    ('nc_lease', 'ind_noncash', 'Arrendamiento financiero (se presenta en financiamiento)', 'indirect'),
    ('nc_rou', 'ind_noncash', 'Arrendamientos reconocidos sin flujo (NIF D-5)', 'indirect'),
    ...
    ('unclassified', 'ind_wc', 'Partidas sin clasificar (revisar)', 'indirect'),
    ...
    ('fin_loans_received', 'ind_financing', 'Préstamos obtenidos', 'indirect'),
    ('fin_loans_paid', 'ind_financing', 'Pago de préstamos', 'indirect'),
    ('fin_lease', 'ind_financing', 'Pago de arrendamiento financiero', 'indirect'),
    ('fin_interest', 'ind_financing', 'Intereses pagados', 'indirect'),
    ('fin_related', 'ind_financing', 'Partes relacionadas', 'indirect'),
    ('fin_equity', 'ind_financing', 'Aportaciones de capital y dividendos', 'indirect'),
    ...
    ('d_suppliers', 'dir_operating', 'Pagos a proveedores y acreedores', 'direct'),
    ('d_payroll', 'dir_operating', 'Pagos de nómina y prestaciones', 'direct'),
    ('d_taxes', 'dir_operating', 'Impuestos y cuotas pagados', 'direct'),
    ('d_bank_fees', 'dir_operating', 'Comisiones bancarias pagadas', 'direct'),
    ('d_interest_received', 'dir_operating', 'Intereses cobrados', 'direct'),
    ('d_other_income', 'dir_operating', 'Otros ingresos cobrados', 'direct'),
    ('d_other', 'dir_operating', 'Otros movimientos (revisar)', 'direct'),
    # ---- Metodo directo: inversion ---------------------------------------
    ('d_assets_bought', 'dir_investing', 'Adquisición de activo fijo', 'direct'),
    ('d_assets_sold', 'dir_investing', 'Venta de activo fijo', 'direct'),
    ('d_insurance', 'dir_investing', 'Indemnizaciones de seguros', 'direct'),
    # ---- Metodo directo: financiamiento ----------------------------------
    ('d_loans_received', 'dir_financing', 'Préstamos obtenidos', 'direct'),
    ('d_loans_paid', 'dir_financing', 'Pago de préstamos', 'direct'),
    ('d_lease', 'dir_financing', 'Pago de arrendamientos', 'direct'),
    ('d_interest', 'dir_financing', 'Intereses pagados', 'direct'),
    ('d_related', 'dir_financing', 'Partes relacionadas', 'direct'),
    ('d_equity', 'dir_financing', 'Aportaciones de capital y dividendos', 'direct'),
...
SECTIONS = [
    ...
    ('ind_noncash', 'Partidas relacionadas con actividades de inversión y financiamiento y sin efecto en efectivo'),
    ('ind_wc', 'Cambios en el capital de trabajo'),
