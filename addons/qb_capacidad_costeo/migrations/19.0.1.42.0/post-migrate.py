# -*- coding: utf-8 -*-
"""Recalcula tras el barrido de limpieza del motor (1.37-1.42).
...
· Inspección de importados (1.41): todo lo importado pasa por una OP
  ...
  resta del pool.
· Recargo de aduana por COMPRA, no por producto (1.42): el mismo hilo
  comprado a un comerciante nacional ya trae el arancel en el precio
  (FILAFIL $65 ≈ importado $48.8 × 1.32) — recargarlo de nuevo lo
  contaba dos veces. El recargo solo aplica cuando la compra usada es de
...
def migrate(cr, version):
    ...
    _logger.info(
        'qb_capacidad_costeo 1.42: limpieza del motor — %s períodos '
