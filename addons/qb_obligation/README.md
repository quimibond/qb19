...
| Qué | Dónde | Cómo |
|---|---|---|
| Obligaciones | Contabilidad → Obligaciones → Mis obligaciones / Todas | Lista agrupada por cliente; botones *Sí, es mía*, *Ya se cumplió*, *Descartar*, *Cancelar*; chatter con el historial. |
...
| Métricas | Contabilidad → Obligaciones → Métricas | Pivot por semana de creación y estado: cobrado, días para cerrar. Descartadas / creadas es la tasa de ruido del origen de correo. |
